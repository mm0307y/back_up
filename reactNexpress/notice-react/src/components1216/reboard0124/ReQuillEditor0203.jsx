...
import { reUploadImageDB } from '../../service1216/dbLogic1218'
...
const ReQuillEditor0203 = ({value, handleContent, quillRef}) => {
  const imageHandler = useCallback(() => {
      ...
      input.onchange = async () => {
        try {
          ...
          const res = await reUploadImageDB(formData)
...
export default ReQuillEditor0203